<div className="font-type">
  <div className="modal" id="disclaimer-modal">
    ...
    <div id="disclaimer-modal-body">
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce nisi lacus,
      lacinia sit amet erat vel, lacinia convallis mi.
    ...
    <section id="hub-flex-container">
      <div id="description-box">
        ...
        <p id="description">
          ...
          vitae aliquet quam. Duis euismod lacus nec ex convallis, et
          condimentum nisi tempus. Ut et lorem sodales nibh egestas tincidunt
          non vitae nulla.
        </p>
    ...
    <section>
      ...
      <div id="steps-flex-box">
        <p className="steps" id="step-one">
          1. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eu
          leo bibendum, sagittis est ut, varius dui.
        </p>

        <p className="steps" id="step-two">
          2. Ut facilisis mauris quis lacus condimentum, eget rutrum est congue.
        </p>

        <p className="steps" id="step-three">
          3. Sed lobortis quam ac tortor lobortis, vel convallis eros ultricies.
          In eu augue diam.
        </p>
      </div>
    </section>
